...
const elements = [
  ...
  'H', 'Hidrogeno', 0, 1, 1, 1.008, 0.08988, -259.16, -252.88,
  ...
  'N', 'Nitrogeno', 0, 15, 2, 14.007, 1.251, -210, -195.79,
  'O', 'Oxigeno', 0, 16, 2, 15.999, 1.429, -218.79, -182.96,
  'F', 'Fluor', 0, 17, 2, 18.9984031636, 1.696, -219.67, -188.12,
  ...
  'P', 'Fosforo', 0, 15, 3, 30.9737619985, 1.823, null, null,
  'S', 'Sulfuro', 0, 16, 3, 32.06, 2.07, 115.21, 444.65,
  ...
  'Ni', 'Niquel', 6, 10, 4, 58.69344, 8.908, 1454.85, 2729.85,
  ...
  'As', 'Arsenico', 4, 15, 4, 74.9215956, 5.727, null, null,
  'Se', 'Selenio', 0, 16, 4, 78.9718, 4.81, 220.85, 684.85,
  'Br', 'Bromo', 0, 17, 4, 79.904, 3.1028, -7.35, 58.85,
  'Kr', 'Kripton', 1, 18, 4, 83.7982, 3.749, -157.37, -153.22,
  ...
  'Sn', 'Estano', 5, 14, 5, 118.7107, 7.365, 231.93, 2601.85,
  ...
  'Ta', 'Tantalo', 6, 5, 6, 180.947882, 16.69, 3016.85, 5457.85,
  ...
  'Ts', 'Teneso', 9, 17, 7, 294, 7.17, 449.85, 609.85,
  'Og', 'Oganeson', 9, 18, 7, 294, 4.95, null, 76.85,
  ...
  'Es', 'Einstenio', 8, 13, 9, 252, 8.84, 859.85, 995.85,
...
for (let i = 0, l = elements.length / ELEMENT_STRIDE; i < l; i += 1) {
  ...
  $description.innerHTML = [
    `Masa atomica: ${elements[offset + ELEMENT_FIELDS.ATOMIC_MASS]} u`,
    `Densidad: ${elements[offset + ELEMENT_FIELDS.DENSITY]} g/cm3`,
    `Punto de fusion: ${elements[offset + ELEMENT_FIELDS.MELTING_POINT]} &deg;C`,
    `Punto de ebullicion: ${elements[offset + ELEMENT_FIELDS.BOILING_POINT]} &deg;C`,
  ].join('<br>');
